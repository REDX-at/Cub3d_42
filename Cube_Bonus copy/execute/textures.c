...
/*   Updated: 2024/09/06 15:34:43 by aitaouss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_weapon(t_data *data)
{
	...
	load_weapon(data, data->weapon_official, "textures/weapon_texture/weapon.xpm");
	data->weapon_zoom = init_weapon(data);
	load_weapon(data, data->weapon_zoom, "textures/weapon_texture/weapon_down.xpm");
	data->weapon_shoot = init_weapon(data);
	load_weapon(data, data->weapon_shoot, "textures/weapon_texture/weapon_red.xpm");
	data->weapon_offic_1 = init_weapon(data);
	load_weapon(data, data->weapon_offic_1, "textures/weapon_texture/weapon_frame_1.xpm");
	data->weapon_offic_2 = init_weapon(data);
	load_weapon(data, data->weapon_offic_2, "textures/weapon_texture/weapon_frame_2.xpm");
	data->weapon_offic_3 = init_weapon(data);
	load_weapon(data, data->weapon_offic_3, "textures/weapon_texture/weapon_frame_3.xpm");
	data->weapon_offic_4 = init_weapon(data);
	load_weapon(data, data->weapon_offic_4, "textures/weapon_texture/weapon_frame_4.xpm");
	data->weapon_offic_5 = init_weapon(data);
	load_weapon(data, data->weapon_offic_5, "textures/weapon_texture/weapon_frame_5.xpm");
}
t_textures	*init_textures(t_data *data)
{
	...
	data->texture_door = ft_strdup("textures/door.xpm");
	t_textures *textures;
...
void    get_texture(t_data *data)
{
	...
	load_textures(data, "textures/black_screen.xpm", data->textures_black_screen);
	data->textures_start_screen = init_textures(data);
	load_textures(data, "textures/start_screen.xpm", data->textures_start_screen);
}
